 ...
 *
 */
object RulesBibliographySegmentor {
  private def checkAndSegmentReferences(lines: mutable.MutableList[Span], predictedLabels: Sequence, result: RulesBibliographySegmentor.ReferenceData): String = {
    var warning: String = ""
...
class RulesBibliographySegmentor {
  ...
  private def transformFromCrfToRulesPipe(): Pipe = {
    ...
    pipes.+=(new NewHtmlTokenization2LineInfo)
  ...
  def segmentReferences(htmlTokenization: NewHtmlTokenization): RulesBibliographySegmentor.ReferenceData = {
    ...
    val ret: RulesBibliographySegmentor.ReferenceData = new RulesBibliographySegmentor.ReferenceData
    ...
    val warning: String = RulesBibliographySegmentor.checkAndSegmentReferences(lineSpans, predictedLabels, ret)
    return ret
  }
}
