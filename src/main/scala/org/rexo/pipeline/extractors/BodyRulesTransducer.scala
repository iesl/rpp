 ...
 */
class BodyRulesTransducer {
  def transduce(data: NewHtmlTokenization): Sequence = {
...
//          }
  ...
  //          }
            ...
            val futureLayout: Boolean = LayoutUtils.isAnyOfFeaturesInFuture(data, i, relaxedFeaturesTableContent, 3, 10)
            ...
            val futureFigureLayout: Boolean = LayoutUtils.isFigureInTheFuture(data, i, if (LayoutUtils.isActiveFeature(currentSpan, "lineWidth20pxLess")) 15 else 6)
...
//    }
  ...
  private def columnInFutureWithTitles(i: Int, data: NewHtmlTokenization, linesInFuture: Int): Boolean = {
//    {
      var cnt: Int = 0
...
//    }
  ...
  def addLabelToAllSpans(span: Span, label: String, transducedData: TokenSequence, data: NewHtmlTokenization, tokenId: Int): Int = {
    span.getEndIdx
    var tok: Span = null
